...
export default [
  ...
  },
  {
    rules: {
      ...
      'vue/max-attributes-per-line': 'off', // 关闭此规则，由Prettier处理
      ...
      // Vue缩进规则已由Prettier处理，移除以避免冲突

      // General JS rules (格式化相关规则已移除，由Prettier处理)
      ...
      // 注意：所有格式化相关的规则（如缩进、空格、引号、分号等）已移除，
      // 这些现在由 Prettier 处理，以避免冲突
    },
  },
];
